      ...
      <li classname="pricingTable-firstTable_table">
        ...
        <ul classname="pricingTable-firstTable_table__options selector">
          ...
          <li>
            ...
            materials. Place purchasing requests.
          </li>
          <li>
          ...
          <li>
            Natural Language Processing NLP for Data Cleansing and Building Data
            Robustness
          </li>
          <li>
            Create beautiful, professional invoices &amp; estimates in just a few
          ...
          <li>
            Scan inventory into your orders, generate barcodes for your documents,
            and search for inventory or documents by scanning barcodes.
          </li>
          ...
          <li>
            With integrated purchase orders, you can easily replenish your
            inventory levels by ordering more stock and even track when those new
            items will arrive.
          </li>
          <li>Partial orders fulfil</li>
          <li>Backordering</li>
          <li>
            Generate extremely detailed reports for your inventory, sales and
